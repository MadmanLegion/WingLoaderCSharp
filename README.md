...
WingLoader-C# is a ground up re-implementation of the excellent work done by Destro in WingLoader - it's not as pretty as Destro's work (https://www.wcnews.com/chatzone/threads/wing-loader-ks-wcdx-loader-voice-over-mod.30387/) , but it has some new tricks!
...
# What 3rd party code does a built package contain?
...
# How to use the tool to play WC in an enhanced format:
How to get started
...
# Building WingLoaderCSharp
- The code is written in C# in .Net 10.    Visual Studio 2026 will suffice.
- You will need to install the required Nuget dependencies
- Grab FFMPEG binaries and SDL2 2.30 binaries as described above and put them into the following relative folders:
